...
import microservices.book.gamification.game.LeaderBoardServiceImpl;
...
public class LeaderBoardServiceImplTest {
    ...
    public void retrieveLeaderBoardTest() {
        // given
        LeaderBoardRow row = new LeaderBoardRow(1L, 300L, List.of());
        given(scoreRepository.findFirst10()).willReturn(List.of(row));
